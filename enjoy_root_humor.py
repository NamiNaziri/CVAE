...
class Main:
    def __init__(self):
        ...
        self.ys = np.concatenate([self.rb_root_vel_inv[...,:2], self.rb_root_ang_vel,], axis=-1)
    ...
    def update(self, delta_t):
        ...
        z, decoded, _, _, _, _= self.cvae.forward(
               orig_x,
                orig_ys.reshape(1,-1),
            )
...
#############
        ...
        cvae_decoded = np.concatenate([self.dof_pos[[[0]]]], axis=-2)
