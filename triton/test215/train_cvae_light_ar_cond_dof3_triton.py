...
def main():
    ...
    if(args.use_cache):
        ...
        xs = [np.concatenate([t2[...,:2], t3 ,t1.reshape(t1.shape[0],-1)], axis=-1) for (t1,t2,t3,t4,t5) in zip(dof_pos,rb_root_vel_inv,rb_root_ang_vel,rb_body_vel_inv,rb_body_pos_inv  )]
