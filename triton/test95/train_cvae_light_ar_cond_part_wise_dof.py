...
from torch_nets import PartWiseVAE, ConditionalVAE, ThroughDataset, ConditionalPartWiseVAE, ARConditionalPartWiseVAE, ARConditionalPartWiseVAE2, ARConditionalPartWiseVAE3, ARConditionalPartWiseVAE4, ARConditionalPartWiseVAE5, ARConditionalPartWiseVAE6
# import debugpy
...
def main():
    ...
    if args.checkpoint_path is None:
        model = ARConditionalPartWiseVAE6(
            nail_sizes,
