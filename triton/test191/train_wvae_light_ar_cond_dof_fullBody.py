...
def main():
    ...
    if args.checkpoint_path is None:
        ...
        criterion3 = torch.nn.BCEWithLogitsLoss(pos_weight=pos_weight)
        criterion3.cuda()
    else:
        #TODO Fix this
    ...
    while global_steps_elapsed <= n_total_steps:
        ...
        if global_steps_elapsed < n_total_steps:
            ...
            for i, (x,y, gt) in enumerate(dataloader):
                ...
                d_z_hat_loss = criterion2(d_z_hat, torch.zeros_like(d_z_hat))
                ...
                d_loss = args.lambda_val * criterion3(d_z_hat2, torch.ones_like(d_z_hat2))
