...
class Main:
    def __init__(self):
        ...
        self.ys = np.concatenate([self.rb_root_vel_inv[...,:2], self.rb_root_ang_vel,self.dof_pos.reshape(self.dof_pos.shape[0],-1)], axis=-1)
...
#############
        ...
        # cvae_decoded[..., 2] = self.engine.get_val("dim_2")
        # cvae_decoded[..., 3] = self.engine.get_val("dim_3")
        # cvae_decoded[..., 4] = self.engine.get_val("dim_4")
