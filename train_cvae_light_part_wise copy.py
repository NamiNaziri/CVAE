...
def main():
    ...
    lower_body = ["Pelvis", "L_Hip", "L_Knee", "L_Ankle", "L_Toe", "R_Hip", "R_Knee", "R_Ankle", "R_Toe"]
    ...
    main_body=["Pelvis", "Torso", "Spine", "Chest", "Neck", "Head"]



    chains=[upper_body, lower_body ]
    #chains=[main_body, right_leg, left_leg, right_arm, left_arm]
    #chains=[left_arm, main_body, right_leg, left_leg, right_arm, ]
    chains_indecies = []
